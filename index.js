...
function createRow(key, obj) {
    return `<div class="row" data-row-id="${obj["id"]}">
                <div data-type="amount" class="col">
                    ...
                    <input onkeypress="setRowData(event, ${obj["id"]}, '${key}', 'amount')" id="change-amount" type="number" step="0.0001" />
                    <button onclick="changeRow(${obj["id"]}, 'amount')" class="change-amount-btn">изменить</button>
                </div>
                <div data-type="course" class="col">
                    <span id="course">${obj["course"]}</span>
                    <input onkeypress="setRowData(event, ${obj["id"]}, '${key}', 'course')" id="change-course" type="number" step="0.0001" />
                    <button onclick="changeRow(${obj["id"]}, 'course')" class="change-course-btn">изменить</button>
                </div>
                <div class="col">
